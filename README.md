...
```
python scripts/evaluate_correstness.py --architcture {G/RTG-vanilla/RTG-query-gen} 
```
### Attribution
...
```
python scripts/citations_eval.py --architcture {G/RTG-vanilla/RTG-query-gen} --autoais {Cit, Pssg, ALCE} --overlap
```
